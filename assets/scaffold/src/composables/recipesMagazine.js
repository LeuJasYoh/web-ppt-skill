...
/* 缓动从 magazine.css :root 的 --ease-editorial 读取，CSS 是唯一事实源（解析失败才用兜底值）。
   与 recipesSwiss 的 cssEase 同一模式，禁止再回到 JS 硬编码双维护 */
...
const EASE = () => cssEase('--ease-editorial', [.22, 1, .36, 1])
let pipeStep = -1
